...
export const CANONICAL_VERTICALS = [
  "Accounting Software","Antivirus","Background Checks","Banking","Bingo","Braces","Business Applications","Business Applications Hub","Business Insurance","Business Loans","Business VoIP","Car Insurance","Car Loans","Car Selling","Car Warranty","Online Casino","Contact Lenses","Credit Cards","CRM","Cyber Security Hub","Data Analysis Software","Dating","Debt Consolidation","Debt Funnel","DNA Testing","E-Commerce","ED (Men’s Health)","Editing Apps","Flower Delivery","Gold & Silver","Hair Loss","Hearing Aids","Home Insurance","Home Security","Home Warranty","Web Hosting","Web Hosting (SaaS)","Identity Theft Protection","In-App","Internet Providers","Investments","Invoicing","Lab-Grown Diamonds","Language Learning","Legal Services","Life Insurance","Life Insurance (Fintech)","LLC","Marketing Tools Hub","Meal Delivery","Medical Alerts","Mobile Plans","Money Transfer","Mortgage","Moving Companies","Online Banking","Online Degrees","Online Therapy","Parental Control","Password Manager","Payroll","Personal Loans","Pet Food Delivery","Pet Insurance","Pet Subscription Boxes","PGR (Pro Group Racing)","Poker","POS & Payments","Printing Services","Private Student Loans","Project Management","Psychic Reading","Remote Access","Renters Insurance","Resume Builders","Slots (Casino)","Solar","Sports Betting","Student Loans","Tax Relief","Tax Software","Tech Bootcamps","Teeth Whitening","Telecom","Top Offers (FR)","Top10","Travel Insurance","TV Services","TV Streaming","Vitamins","VPN","Walk-in Tubs","Web Design","Website Builders","Website Builders (SaaS)","Weight Loss","Weight-loss Plans","WSB","MAS","HS","HW"
];

/**
 * Collapse raw labels (with country/variants) into canonical ones.
 * Returns a known canonical vertical or "Other/Legacy".
 * @param {string} raw
 * @returns {string}
 */
export function canonicalizeVertical(raw) {
  const s = (raw || '').trim();
  const noLocale = s.replace(/\s+(UK|US|CA|MX|FR|DE|RO|SE|IE|IT|NL|PT|SP|AU|BR|RU)\b/gi, '').trim();
  const is = (re) => re.test(noLocale);
